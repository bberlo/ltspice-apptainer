...
# Execute run
apptainer run --writable-tmpfs --cleanenv --fakeroot --env LTSPICE_EXE="$LTSPICE_PATH" --env XVFB_DISP="$XVFB_DISPLAY" --env XVFB_RES="$XVFB_RESOLUTION" --env THE_FILE="$RUN_FILE" \
